...
============*/
/* HIGHLIGHT: CHANGE ====================
    The function copyCurrency() (pure virtual in Currency class) is defined here to make a copy of the currency objects so as to not accidentally alter it later on
==================== HIGHLIGHT: CHANGE */
#ifndef DOLLAR_H
#define DOLLAR_H
